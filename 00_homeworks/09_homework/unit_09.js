...
function f6() {
    out6.textContent = document.getElementsByClassName('p-6').length;
}
...
function f18() {
    out18.textContent = document.querySelector('.p-18').getAttribute('data-b');
}
...
function f19() {
    ...
    for (let i = 0; i < block19.length; i++) {
        out19 += `${block19[i].getAttribute('data-b')} `;
    }
